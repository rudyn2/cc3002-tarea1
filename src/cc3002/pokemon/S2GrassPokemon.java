...
public class S2GrassPokemon extends AbstractGrassPokemon {
    public S2GrassPokemon(int hp, String name, int id, ArrayList<IAttack> attacks, ArrayList<IAbility> abilities) {
