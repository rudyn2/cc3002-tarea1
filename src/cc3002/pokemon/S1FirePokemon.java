...
public class S1FirePokemon extends AbstractFirePokemon {
    public S1FirePokemon(int hp, String name, int id, ArrayList<IAttack> attacks, ArrayList<IAbility> abilities) {
