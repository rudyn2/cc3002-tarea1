...
public class BasicElectricPokemon extends AbstractElectricPokemon {
    public BasicElectricPokemon(int hp, String name, int id, ArrayList<IAttack> attacks, ArrayList<IAbility> abilities) {
