...
public class S1PsychicPokemon extends AbstractPsychicPokemon {
    public S1PsychicPokemon(int hp, String name, int id, ArrayList<IAttack> attacks, ArrayList<IAbility> abilities) {
