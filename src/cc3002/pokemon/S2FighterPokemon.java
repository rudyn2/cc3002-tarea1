...
public class S2FighterPokemon extends AbstractFighterPokemon {
    public S2FighterPokemon(int hp, String name, int id, ArrayList<IAttack> attacks, ArrayList<IAbility> abilities) {
