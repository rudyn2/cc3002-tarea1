...
public class S1FighterPokemon extends AbstractFighterPokemon {
    public S1FighterPokemon(int hp, String name, int id, ArrayList<IAttack> attacks, ArrayList<IAbility> abilities) {
