...
public class S2PsychicPokemon extends AbstractPsychicPokemon {
    public S2PsychicPokemon(int hp, String name, int id, ArrayList<IAttack> attacks, ArrayList<IAbility> abilities) {
