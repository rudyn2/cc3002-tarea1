...
public class S1WaterPokemon extends AbstractWaterPokemon {
    public S1WaterPokemon(int hp, String name, int id, ArrayList<IAttack> attacks, ArrayList<IAbility> abilities) {
