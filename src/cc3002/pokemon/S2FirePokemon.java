...
public class S2FirePokemon extends AbstractFirePokemon {
    public S2FirePokemon(int hp, String name, int id, ArrayList<IAttack> attacks, ArrayList<IAbility> abilities) {
