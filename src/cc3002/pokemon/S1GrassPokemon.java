...
public class S1GrassPokemon extends AbstractGrassPokemon {
    public S1GrassPokemon(int hp, String name, int id, ArrayList<IAttack> attacks, ArrayList<IAbility> abilities) {
